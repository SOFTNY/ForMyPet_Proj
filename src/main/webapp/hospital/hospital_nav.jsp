...
<nav class="navbar navbar-expand-lg navbar-light bg-success" style="--bs-bg-opacity: .5;">
  <div class="container-fluid">
    <a class="navbar-brand text-white" href="/web/home.jsp"><i class="fa-solid fa-paw text-success" style="font-size:23px;"> For my pet</i></a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link active text-white" aria-current="page" href="/web/home.jsp"><i class="fa-solid fa-house text-success"></i> <i>&nbsp;Home</i></a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="hospital.jsp"><i class="fa-solid fa-circle-h text-success"></i>  <i>&nbsp;Animal hospital</i></a>
        </li>
        <li class="nav-item">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
          <a class="nav-link text-white" href="/web/login.jsp"><i class="fa-solid fa-user text-success"></i> <i>&nbsp;Login</i></a>
        </li>
      </ul>
    </div>
  </div>
