...
<footer>
	<div class="footer bg-success" style="--bs-bg-opacity: .5;">
		<div class="col-1" id="box1">
			<a class="text-white" aria-current="page" href="./home.jsp"><i class="fa-solid fa-house text-success"></i> <i>&nbsp;Home</i></a>
			<a class="text-white" href="./hospital/hospital.jsp"><i class="fa-solid fa-circle-h text-success"></i>  <i>&nbsp;Animal hospital</i></a>
			<a class="text-white" href="./walkway/walkway.jsp"><i class="fa-solid fa-tree text-success"></i>  <i>&nbsp;Walkway</i></a>
			<a class="text-white" href="./post/post_list.jsp"><i class="fa-solid fa-signs-post text-success"></i> <i>&nbsp;Animal Post</i></a>
			<a class="text-white" href="./login.jsp"><i class="fa-solid fa-user text-success"></i> <i>&nbsp;Login</i></a>
		</div>
		<div class="col-2">
			    <a class="text-white" href="./home.jsp"><i class="fa-solid fa-paw text-success" style="font-size:23px;"> For my pet</i></a>
			<form>
